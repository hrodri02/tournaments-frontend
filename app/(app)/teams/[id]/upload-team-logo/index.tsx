        ...
        view = <View style={styles.container}>
            <View style={[styles.container, styles.perfectCentering]}>
                <Pressable onPress={pickImage}>
                    <Text style={styles.subtext}>{t('upload_team_logo.message')}</Text>
                </Pressable>
                {imageUri && (
                    <Image 
                        source={{ uri: imageUri }} 
            ...
            <Pressable onPress={skipUpload}>
                <Text style={styles.centerText}>{t('upload_team_logo.skip_button')}</Text>
            </Pressable>
        </View>
    }
    else if (updateStatus === 'succeeded') {
        view = <View style={[styles.container, styles.perfectCentering]}>
            <Text>{t('upload_team_logo.success_message')}</Text>
